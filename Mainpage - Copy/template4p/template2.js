function addNewEQField(){
 ...
 function generateCV(){
    ...
    document.getElementById('married').innerHTML = document.getElementById('nsField').value;

    document.getElementById('gender').innerHTML = document.getElementById('genField').value;
